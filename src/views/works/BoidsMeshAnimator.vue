<template>
    <v-container>
        <v-layout align-center column justify-center>
            ...
            <h1 class="Display-3 font-weight-medium my-3 text-center">BoidsMeshAnimator</h1>
            <h4 class="font-weight-light mb-3">個人開発</h4>
            <a href="https://github.com/Octan008/BoidsMeshAnimation" target="_blank">https://github.com/Octan008/BoidsMeshAnimation</a>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/wcvwxlFzYEA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            ...
            <h4 class="font-weight-light md-mx-12">I create a VTuber engine that reflects the three-axis rotation of the
                ...
                humans in a hyper-realistic CG space and making them feel as if they are in a real space.
            </h4>
