<template>
    <v-container>
        <v-layout align-center column justify-center>
            ...
            <h1 class="Display-3 font-weight-medium my-3 text-center">Wifiモニタリングサイト</h1>
            <h4 class="font-weight-light mb-3">大学のアルバイトで制作した Webページ。学内の Wifi アクセスポイントの接続状況を地図上に表示し、Cookieを用いてよく使う地図をストックできる。</h4>

            <img width="width" :height="height" src="@/assets/works/wifi.png">
